...
ROOT_URLCONF = 'parasuram_portfolio.urls'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'portfolio.context_processors.site_data',
            ],
        },
    },
]

WSGI_APPLICATION = 'parasuram_portfolio.wsgi.application'
...
DEFAULT_FROM_EMAIL = config('DEFAULT_FROM_EMAIL', default='Portfolio Contact <noreply@parasuram.com>')
CONTACT_EMAIL = config('CONTACT_EMAIL', default='') # Receiver email
